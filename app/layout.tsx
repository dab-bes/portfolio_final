...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="flex min-h-dvh min-h-full flex-col bg-[url('/background.jpg')] bg-center bg-no-repeat max-md:bg-[length:275%_auto] md:bg-cover bg-[color:var(--background)]">
        <SceneProvider>
